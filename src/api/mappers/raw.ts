...
const rawParliamentarianFields = {
  ...
  kommissionen_abkuerzung: Schema.optionalWith(Schema.String, {
    nullable: true,
  }),
  kommissionen_namen: Schema.optionalWith(Schema.String, { nullable: true }),
  ...
  partei: Schema.optionalWith(Schema.String, { nullable: true }),
  partei_name: Schema.optionalWith(Schema.String, { nullable: true }),
